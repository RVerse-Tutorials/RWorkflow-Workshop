...
R Markdown is a format that allows you to combine text and R code.  From RStudio you can output your file in many formats: html, PDF, Word, presentations.

## Get the template from GitHub

The course website has a set of example R Markdown files for you to work with.  You need to download the files from GitHub.

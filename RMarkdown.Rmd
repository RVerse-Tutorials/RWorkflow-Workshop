...
[Fork](https://youtu.be/b6AaTHFIY7U) the repository [Rmarkdown-Tutorial](https://github.com/RVerse-Tutorials/Rmarkdown-Tutorial) or download a zip file of the repository.  To do the latter, you can navigate to your 'RWorkflow' folder in RStudio and click 'More' in the Files panel and select 'Set as working directory'. Then issue these commands.
...
* Presentations
  ...
  - **xaringan_presentation.Rmd** This is the file that produced a lecture in the forecasting workshop.  You will need to install xaringan
```

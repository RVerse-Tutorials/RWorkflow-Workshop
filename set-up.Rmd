...
You need to download repositories from [RVerse-Tutorials](https://github.com/RVerse-Tutorials) for many of the labs.  There are a few ways that you can do this.

## Get a repository from GitHub

Here is how to download the 'Rmarkdown-Tutorial' repository from the [RVerse-Tutorials](https://github.com/RVerse-Tutorials/) GitHub account.  To download other repositories, just change the repository name.

### Method #1 Download from within R

This is the method I will show in the lectures. The 'RWorkflowsetup' package has a download function. This function will create a folder with the name of the repository.
...
Go to https://github.com/RVerse-Tutorials/Rmarkdown-Tutorial and click 'Clone or download' and chose 'Download Zip'.  Unzip and you'll probably want to remove  'master' added to the end of the repository name.
